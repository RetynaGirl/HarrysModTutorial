...
public class WorldGenMahoganyTree extends WorldGenAbstractTree {
	...
	public static IBlockState LOG = BlockInit.LOG_MAHOGANY.getStateFromMeta(1);
	public static final IBlockState LEAF = BlockInit.LEAVES_MAHOGANY.getDefaultState();
	...
	public boolean generate(World worldIn, Random rand, BlockPos pos) {
		...
		if (!flag) {
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, worldIn, down, EnumFacing.UP,
					(BlockBaseSapling) BlockInit.SAPLING_MAHOGANY);
