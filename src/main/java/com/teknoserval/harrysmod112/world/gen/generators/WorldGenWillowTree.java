...
public class WorldGenWillowTree extends WorldGenAbstractTree {
	...
	public static IBlockState LOG = BlockInit.LOG_WILLOW.getStateFromMeta(1);
	public static final IBlockState LEAF = BlockInit.LEAVES_WILLOW.getDefaultState();
	...
	public boolean generate(World worldIn, Random rand, BlockPos pos) {
		...
		if (!flag) {
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, worldIn, down, EnumFacing.UP,
					(BlockBaseSapling) BlockInit.SAPLING_WILLOW);
